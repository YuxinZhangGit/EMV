...
parser.add_argument("--mlm_name_or_path",type=str,default="bert-base-chinese")
parser.add_argument("--save_path",type=str,default="bert")
...
if __name__=='__main__':
    ...
    train_dataset=[]
    test_dataset=[]
    with open("/home/zxy/coling/data/lecard/train.json","r") as f:
        for line in f:
            if line:
                js=json.loads(line)
